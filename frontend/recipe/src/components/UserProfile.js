...
const UserProfile = ({ loggedInUser }) => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        try {
            const countResponse = await axios.get(`https://recipe-backend-wntf.onrender.com/api/recipe/count/${userId}`);
  ...
  useEffect(() => {
    const fetchFollowers = async () => {
      try {
        const response = await axios.get(`https://recipe-backend-wntf.onrender.com/api/user/${userId}/followers`);
  ...
  const handleFollow = async () => {
    ...
    try {
      await axios.post(`https://recipe-backend-wntf.onrender.com/api/user/${userId}/follow`, { followerId: loggedInUser._id });
  ...
  const handleUnfollow = async () => {
    ...
    try {
      await axios.delete(`https://recipe-backend-wntf.onrender.com/api/user/${userId}/unfollow`, { data: { followerId: loggedInUser._id } });
